...
const Sidebar: React.FC<SidebarProps> = ({ currentView, setView, onLogout }) => {
    ...
    const navItems = [
        ...
        { id: 'familyRegistrations', label: 'Family Registrations', icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M15 21v-2a4 4 0 00-4-4H9a4 4 0 00-4 4v2"></path></svg>, badge: 0 }
    ];
