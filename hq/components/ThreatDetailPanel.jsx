...
import { analyzeThreatWithAI } from '../api.js';

const ThreatDetailPanel = ({ threat, onClose, onStatusChange, onThreatUpdate }) => {
  ...
  const InfoField = ({ label, value, valueClass, colSpan }) => (
  ...
  const ContextualIntelligence = ({ threat }) => {
