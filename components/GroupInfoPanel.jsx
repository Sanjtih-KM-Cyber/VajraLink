...
import { getGroupDetails, getOperatives, removeMemberFromGroup, addMemberToGroup, leaveGroup, deleteGroup } from '../hq/api.js';
...
const GroupInfoPanel = ({ chatInfo, currentUser, onClose, onGroupUpdate, onSelectChat }) => {
