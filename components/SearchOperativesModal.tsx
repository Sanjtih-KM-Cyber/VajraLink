...
import { searchOperatives, submitConnectionRequest } from '../hq/api';

interface SearchOperativesModalProps {
  onClose: () => void;
  currentUser: string;
}
...
const SearchOperativesModal: React.FC<SearchOperativesModalProps> = ({ onClose, currentUser }) => {
  const [query, setQuery] = useState('');
  const [results, setResults] = useState<Operative[]>([]);
