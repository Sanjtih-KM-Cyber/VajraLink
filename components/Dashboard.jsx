...
import { getContactsForUser, getGroupsForUser, getOperativeProfile, setStatusVisibility, updateOperativeStatus } from '../hq/api.js';

// In a real app, this would come from the auth context
const CURRENT_USER = 'agent_zero';

const SettingsMenu = ({ isOpen, onClose, onLogout, theme, setTheme, inactivityDuration, setInactivityDuration, isStatusVisible, onVisibilityChange }) => {
...
const operativeToDmChatInfo = (operative) => {
...
const Dashboard = (props) => {
  ...
  const selectedDmInfo = selectedChat?.type === 'Direct Message' ? selectedChat : undefined;
