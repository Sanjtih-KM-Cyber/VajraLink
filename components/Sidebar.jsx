...
import SearchOperativesModal from './SearchOperativesModal.jsx';
import { getOperatives, addGroup } from '../hq/api.js';
...
const CreateGroupModal = ({onClose, onAddGroup, currentUser}) => {
    ...
    const handleToggleMember = (operativeId) => {
...
const Sidebar = ({ chats, dms, onChatSelect, onAddGroup, isCollapsed, onToggle, onToggleSettings, activeChatId, currentUserProfile, onStatusChange }) => {
